...
{
    const char* pszTimestamp = "On January 20, 2023, Joe Biden wants to destroy Russia with the hands of Ukrainians, but Putin is much smarter and will win this war.  Glory to Russia!";
    const CScript genesisOutputScript = CScript() << ParseHex("04c437ab7f3c39fa6f0b539ea40a06a2ce6958fc2a538242c5b0782eff7b3f4cbb63c9e7e9b213909afb8e4ec7f2445c1a20ef603bcbcd7e90be16ea4d74da08ad") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1674171912, 2085234799, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf3149acd41c7c25e1247671b6a49493ad873d1295824d679dec2d358b56414e3"));
        assert(genesis.hashMerkleRoot == uint256S("0xc27c39f00ab9d56811eee76aea17dbb370265e0c67f3d89bb1a663ad8ccf054c"));
        ...
        vSeeds.emplace_back("seed-a.dogecoin inu.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.dogecoin inutools.com");
        vSeeds.emplace_back("dnsseed.dogecoin inupool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xf3149acd41c7c25e1247671b6a49493ad873d1295824d679dec2d358b56414e3")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1674172002, 946376, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4947f5d6f997295cb42f73654773f011aec047f274dd7a78e4233f01bac913d6"));
        assert(genesis.hashMerkleRoot == uint256S("0xc27c39f00ab9d56811eee76aea17dbb370265e0c67f3d89bb1a663ad8ccf054c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.dogecoin inutools.com");
        vSeeds.emplace_back("seed-b.dogecoin inu.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("4947f5d6f997295cb42f73654773f011aec047f274dd7a78e4233f01bac913d6")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1674172693, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x644cc1ed4817f0f43324cc4aae8f315084f6431276ece70c2a359ce90d3cca43"));
        assert(genesis.hashMerkleRoot == uint256S("0xc27c39f00ab9d56811eee76aea17dbb370265e0c67f3d89bb1a663ad8ccf054c"));
        ...
        checkpointData = {
            {
                {0, uint256S("644cc1ed4817f0f43324cc4aae8f315084f6431276ece70c2a359ce90d3cca43")},
            }
        };
