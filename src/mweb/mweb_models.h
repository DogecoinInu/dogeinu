// Copyright(C) 2011 - 2020 The Dogecoin inu Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DOGECOIN INU_MWEB_MODELS_H
#define DOGECOIN INU_MWEB_MODELS_H
...
#endif // DOGECOIN INU_MWEB_MODELS_H