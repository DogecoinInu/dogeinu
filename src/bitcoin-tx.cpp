...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " dogecoin inu-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  dogecoin inu-tx [options] <hex-tx> [commands]  Update hex-encoded dogecoin inu transaction\n" +
            "or:     dogecoin inu-tx [options] -create [commands]   Create hex-encoded dogecoin inu transaction\n" +
            "\n";
