...
"""Test dogecoin inud with different proxy configuration.

Test plan:
- Start dogecoin inud's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on dogecoin inud side:
