...
"""Verify that starting dogecoin inu with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dogecoin inu with -h for help text")
        ...
        self.log.info("Start dogecoin inu with -version for version information")
        ...
        self.log.info("Start dogecoin inud with -fakearg to make sure it does not start")
