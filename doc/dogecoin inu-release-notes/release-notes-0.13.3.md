Dogecoin inu Core version 0.13.3 is now available from:

  <https://download.dogecoin inu.org/dogecoin inu-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/dogecoinInu/dogecoin inu/blob/0.13/src/chainparams.cpp#L214).
