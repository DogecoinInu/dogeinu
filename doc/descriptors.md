# Support for Output Descriptors in Dogecoin inu Core

Since Dogecoin inu Core v0.17, there is support for Output Descriptors. This is a
...
existing Dogecoin inu Core wallets, a convenience function `combo` is
