Contributing to Dogecoin inu Core
============================

The Dogecoin inu Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Dogecoin inu Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/dogecoin inu-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to dogecoin inu-qt
...
The following applies to code changes to the Dogecoin inu Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Dogecoin inu
Network Protocol consensus changes.

Whether a pull request is merged into Dogecoin inu Core rests with the project merge
...
Patches that change Dogecoin inu consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dogecoin inu consensus, it must have been
...
The project leader is the release manager for each Dogecoin inu Core release.
